...
def main():
    ...
    if "pre_init_pos" in pred:
        print("pre_init_pos shape:", pred["pre_init_pos"].shape)
        print("pre_init_pos[0]:", pred["pre_init_pos"][0])
    else:
        print("pre_init_pos not found")

    if "pre_goal_rel" in pred:
        print("pre_goal_rel shape:", pred["pre_goal_rel"].shape)
        print("pre_goal_rel[0]:", pred["pre_goal_rel"][0])
    else:
        print("pre_goal_rel not found")

    if "pre_init_pos" in pred and "pre_goal_rel" in pred:
        print("pre_goal_abs[0]:", pred["pre_init_pos"][0] + pred["pre_goal_rel"][0])
